...
async function setWallpaper() {
  ...
  hyperFilePath.textContent = await invoke("set_wallpaper", { name: wallpaperInput.value });
  // all this does is create a process ig that calles the set_wallpaper rust function in lib .rs
  // it uses name as the paretmers thing
}
